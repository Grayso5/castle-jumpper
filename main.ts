...
function Startlevel () {
    ...
    tiles.placeOnRandomTile(Player100, assets.tile`myTile3`)
    for (let value of tiles.getTilesByType(assets.tile`myTile3`)) {
        tiles.setTileAt(value, assets.tile`transparency16`)
    }
    Player100.ay = 350
    scene.cameraFollowSprite(Player100)
    for (let value of tiles.getTilesByType(assets.tile`myTile2`)) {
        Lavaball = sprites.create(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.Coin)
        tiles.placeOnTile(Lavaball, value)
        tiles.setTileAt(value, assets.tile`transparency16`)
    }
}
let Lavaball: Sprite = null
let Current_Level = 0
let Player100: Sprite = null
Player100 = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . f f f f f f . . . . . 
    . . . f f e e e e f 2 f . . . . 
    ...
    . . . . f f . . . f f f . . . . 
    `, SpriteKind.Player)
controller.moveSprite(Player100, 100, 0)
